                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className="w-full bg-gray-800 border border-gray-700 text-white placeholder-gray-600 rounded-lg pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500/60 focus:ring-1 focus:ring-emerald-500/30 transition-colors disabled:opacity-50"
                      autoComplete="email"
                      autoFocus
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      disabled={loading}
                      className="w-full bg-gray-800 border border-gray-700 text-white placeholder-gray-600 rounded-lg pl-9 pr-10 py-2.5 text-sm focus:outline-none focus:border-emerald-500/60 focus:ring-1 focus:ring-emerald-500/30 transition-colors disabled:opacity-50"
              ...
              <div className="mt-6 pt-5 border-t border-gray-800">
                <p className="text-xs text-gray-600 text-center">
                  ...
                  <button
                    ...
                    disabled={loading}
                    onClick={onBack}
                    className="text-emerald-500/80 hover:text-emerald-400 transition-colors disabled:opacity-50"
                  >
                    Sign in
                  </button>
                </p>
